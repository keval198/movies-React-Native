...
import { useIsFocused, useFocusEffect } from '@react-navigation/native';
  ...
  React.useLayoutEffect(() =>{
    ...
    const FooterComponent = () =>{
      ...
      }, [props.topRatedMovies,useIsFocused])
  ...
  function mapDispatchToMatch(dispatch){
      return{
          getMoviesTopRated: (pageNum) => dispatch({type:'GET_TOPRATED',pageNum:pageNum})
      }
  }
  
  export default connect(mapStateToprops, mapDispatchToMatch)(Toprated);